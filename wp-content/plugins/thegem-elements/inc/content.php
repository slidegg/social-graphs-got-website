...
function thegem_team($params) {
	...
	if($persons->have_posts()) {
		...
		echo '<div class="gem-team row inline-row gem-team-'.esc_attr($params['style']).'"'.(!empty($params['hover_colors']) ? ' data-hover-colors="'.esc_attr(json_encode($params['hover_colors'])).'"' : '').'>';
	...
	<?php if(!$params['is_ajax']) : ?>
				...
				<?php if ($params['layout'] != '1x'): ?>
					<div class="portfolio-item-size-container">
						<?php $portfolio_item_size = true; $slugs = array(); ?>
						<?php include(locate_template(array('gem-templates/portfolios/content-portfolio-item.php'))); ?>
					</div>
				<?php endif; ?>
				</div><!-- .row-->
...
function thegem_news_grid($params) {
	$params = array_merge(
		array(
			...
			'item_post_title_color' => '',
			'item_post_author_color' => '',
			'item_post_date_color' => '',
			'item_post_excerpt_color' => '',
			'item_post_categories_color' => '',
			'item_post_categories_background_color' => '',
			'item_post_comments_icon_color' => '',
			'item_post_likes_icon_color' => '',
			'item_post_share_icon_color' => '',
			'item_post_share_social_icon_color' => '',
			'item_post_hover_icon_color' => '',
			'item_post_bottom_border_color' => '',
		),
		$params
	);
	...
	if ($params['version'] != 'new' || ($params['display_titles'] == 'hover' && ($params['hover'] == 'horizontal-sliding' || $params['hover'] == 'gradient'  || $params['hover'] == 'circular'))) {
	...
	$grid_uid = substr( md5(rand()), 0, 7);

	$inlineColorsStyles = '';
	$itemSelector = '.portfolio.news-grid[data-portfolio-uid="' . $grid_uid . '"] .portfolio-item';
	...
	if (!empty($params['item_hover_background_color'])) {
		$inlineColorsStyles .= $itemSelector. ' .image .overlay:before { background: ' . esc_attr($params['item_hover_background_color']) . ' !important; }';
		$inlineColorsStyles .= $itemSelector. ' .image .overlay-circle { background: ' . esc_attr($params['item_hover_background_color']) . ' !important; }';
		$inlineColorsStyles .= $itemSelector. ' .image .gem-simple-gallery .gem-gallery-item a:before { background: ' . esc_attr($params['item_hover_background_color']) . ' !important; }';
	}
	if (!empty($params['item_background_color'])) {
		$inlineColorsStyles .= $onPageCaptionSelector. ' { background-color: ' . esc_attr($params['item_background_color']) . ' !important; }';
		$inlineColorsStyles .= $itemSelector. ' .wrap { background-color: ' . esc_attr($params['item_background_color']) . ' !important; }';
	}
	if (!empty($params['item_post_title_color'])) {
		$inlineColorsStyles .= $captionSelector . ' .title { color: ' . esc_attr($params['item_post_title_color']) . ' !important; }';
		$inlineColorsStyles .= $captionSelector . ' .title > * { color: ' . esc_attr($params['item_post_title_color']) . ' !important; }';
		$inlineColorsStyles .= $captionSelector . ' .title a { color: ' . esc_attr($params['item_post_title_color']) . ' !important; }';
	}
	if (!empty($params['item_post_author_color'])) {
		$inlineColorsStyles .= $captionSelector . ' .author .author-name { color: ' . esc_attr($params['item_post_author_color']) . ' !important; }';
	}
	if (!empty($params['item_post_date_color'])) {
		$inlineColorsStyles .= $captionSelector . ' .post-author-date-separator { color: ' . esc_attr($params['item_post_date_color']) . ' !important; }';
		$inlineColorsStyles .= $captionSelector . ' .post-date { color: ' . esc_attr($params['item_post_date_color']) . ' !important; }';
	}
	if (!empty($params['item_post_categories_background_color'])) {
		$inlineColorsStyles .= $onHoverCaptionSelector. ' .info { background-color: ' . esc_attr($params['item_post_categories_background_color']) . ' !important; }';
	}
	if (!empty($params['item_post_categories_color'])) {
		$inlineColorsStyles .= $captionSelector . ' .info .sep { color: ' . esc_attr($params['item_post_categories_color']) . ' !important; border-left-color: ' . esc_attr($params['item_post_categories_color']) . ' !important; }';
		$inlineColorsStyles .= $captionSelector . ' .info a { color: ' . esc_attr($params['item_post_categories_color']) . ' !important; }';
	}
	if (!empty($params['item_post_excerpt_color'])) {
		$inlineColorsStyles .= $captionSelector . ' .description { color: ' . esc_attr($params['item_post_excerpt_color']) . ' !important; }';
		$inlineColorsStyles .= $captionSelector . ' .description .subtitle { color: ' . esc_attr($params['item_post_excerpt_color']) . ' !important; }';
		$inlineColorsStyles .= $captionSelector . ' .grid-post-meta .comments-link a { color: ' . esc_attr($params['item_post_excerpt_color']) . ' !important; }';
		$inlineColorsStyles .= $captionSelector . ' .grid-post-meta .zilla-likes { color: ' . esc_attr($params['item_post_excerpt_color']) . ' !important; }';
		$inlineColorsStyles .= $captionSelector . ' .grid-post-meta .comments-link + .post-meta-likes { border-left-color: ' . esc_attr($params['item_post_excerpt_color']) . ' !important; }';
		$inlineColorsStyles .= $captionSelector . ' .grid-post-meta .grid-post-share + .grid-post-meta-comments-likes .comments-link { border-left-color: ' . esc_attr($params['item_post_excerpt_color']) . ' !important; }';
	}
	if (!empty($params['item_post_comments_icon_color'])) {
		$inlineColorsStyles .= $captionSelector . ' .grid-post-meta .comments-link a:before { color: ' . esc_attr($params['item_post_comments_icon_color']) . ' !important; }';
	}
	if (!empty($params['item_post_likes_icon_color'])) {
		$inlineColorsStyles .= $captionSelector . ' .grid-post-meta .zilla-likes:before { color: ' . esc_attr($params['item_post_likes_icon_color']) . ' !important; }';
	}
	if (!empty($params['item_post_share_icon_color'])) {
		$inlineColorsStyles .= $captionSelector . ' .grid-post-share .icon { color: ' . esc_attr($params['item_post_share_icon_color']) . ' !important; }';
		$inlineColorsStyles .= $captionSelector . ' .grid-post-share .icon:before { color: ' . esc_attr($params['item_post_share_icon_color']) . ' !important; }';
	}
	if (!empty($params['item_post_share_social_icon_color'])) {
		$inlineColorsStyles .= $captionSelector . ' .socials-sharing a.socials-item .socials-item-icon { color: ' . esc_attr($params['item_post_share_social_icon_color']) . ' !important; }';
	}
	if (!empty($params['item_post_hover_icon_color'])) {
		$inlineColorsStyles .= $captionSelector . ' .portfolio-icons a:before { color: ' . esc_attr($params['item_post_hover_icon_color']) . ' !important; }';
		$inlineColorsStyles .= $itemSelector. ' .image .gem-simple-gallery .gem-gallery-item a:after { color: ' . esc_attr($params['item_post_hover_icon_color']) . ' !important; }';
	}
	if (!empty($params['item_post_bottom_border_color'])) {
		$inlineColorsStyles .= $itemSelector . ' .wrap { border-bottom-color: ' . esc_attr($params['item_post_bottom_border_color']) . ' !important; }';
	}

	if (!empty($inlineColorsStyles)) {
		wp_add_inline_style('thegem-news-grid', $inlineColorsStyles);
	}

	$localize = array_merge(
		array('data' => $params, 'action' => 'news_grid_load_more'),
		array(
			'url' => admin_url('admin-ajax.php'),
			'nonce' => wp_create_nonce('portfolio_ajax-nonce')
		)
	);
	wp_localize_script('thegem-portfolio', 'portfolio_ajax_' . $grid_uid, $localize);
	...
	$query_args = array(
		'post_type' => $params['grid_post_types'],
		'post_status' => 'publish',
		'orderby' => $params['orderby'] ? $params['orderby'] : ($params['sorting'] ? 'date' :'menu_order date'),
	...
	if ($params['pagination'] == 'more' || $params['pagination'] == 'scroll') {
		...
		$news_grid_loop = new WP_Query($query_args);
...
<?php if($news_grid_loop->have_posts()) : ?>
	<?php
		...
		if ($params['categories']) {
			$term_args['slug'] = $params['categories'];
		}

		$terms = apply_filters('news_grid_terms_filter', get_terms($term_args));
	...
	<?php if(!$params['is_ajax']) : ?>
		...
		<?php
			...
			$news_grid_classes = array(
				...
				'background-style-' . $params['background_style'],
				'title-style-' . $params['title_style'],
				'hover-' . ($params['version'] == 'new' || ($params['version'] == 'default' && $params['display_titles'] == 'hover') ? $params['version'] . '-' : '') . esc_attr($params['hover']),
				'item-animation-' . $params['loading_animation'],
				'title-on-' . $params['display_titles'],
			...
			if ($gap_size == 0) {
				$news_grid_classes[] = 'no-gaps';
			}

			if ($params['layout'] == '100%') {
				$news_grid_classes[] = 'fullwidth-columns-' . intval($params['fullwidth_columns']);
			}

			if ($params['display_titles'] == 'hover') {
				$news_grid_classes[] = 'hover-title';
			}

			if ($params['style'] == 'masonry' && $params['layout'] != '1x') {
				$news_grid_classes[] = 'portfolio-items-masonry';
			}

			if ($layout_columns_count != -1) {
				$news_grid_classes[] = 'columns-' . intval($layout_columns_count);
			}
		...
		?>
			...
			<div data-per-page="<?php echo $items_per_page; ?>" data-portfolio-uid="<?php echo esc_attr($grid_uid); ?>" class="<?php echo implode(' ', $news_grid_classes); ?>" data-hover="<?php echo $params['hover']; ?>" <?php if($params['pagination'] == 'more' || $params['pagination'] == 'scroll'): ?>data-next-page="<?php echo esc_attr($next_page); ?>"<?php endif; ?>>
				<?php if(($params['with_filter'] && count($terms) > 0) || $params['sorting']): ?>
					<div class="portfilio-top-panel<?php if($params['layout'] == '100%'): ?> fullwidth-block<?php endif; ?>" <?php if ($gap_size && $params['layout'] == '100%'): ?>style="padding-left: <?php echo 2*$gap_size; ?>px; padding-right: <?php echo 2*$gap_size; ?>px;"<?php endif; ?>><div class="portfilio-top-panel-row">
						<div class="portfilio-top-panel-left">
						<?php if($params['with_filter'] && count($terms) > 0): ?>
							...
							<div class="portfolio-filters-resp">
								<button class="menu-toggle dl-trigger"><?php _e('News filters', 'thegem'); ?><span class="menu-line-1"></span><span class="menu-line-2"></span><span class="menu-line-3"></span></button>
								<ul class="dl-menu">
									<li><a href="#" data-filter="*"><?php echo $params['all_text']; ?></a></li>
									<?php foreach($terms as $term) : ?>
										<li><a href="#" data-filter=".<?php echo esc_attr($term->slug); ?>"><?php echo $term->name; ?></a></li>
	...
	<?php endif; ?>
					...
					<?php $eo_marker = false; while ($news_grid_loop->have_posts()) : $news_grid_loop->the_post(); ?>
						<?php $slugs = wp_get_object_terms($post->ID, $taxonomies, array('fields' => 'slugs')); ?>
						<?php include(locate_template(array('gem-templates/news-grid/content-item-'.$params['layout'].'.php', 'gem-templates/news-grid/content-item.php'))); ?>
					<?php $eo_marker = !$eo_marker; endwhile; ?>
...
<?php $post = $news_grid_posttemp; wp_reset_postdata(); ?>
<?php
}
...
function gem_featured_posts_slider($params) {
    ...
    $query_args = array(
        ...
        'orderby' => 'date',
        'order' => $params['order_by']=='date_asc' ? 'ASC' : 'DESC'
    );
    ...
    if ($query->have_posts()) : ?>
        <div class="preloader"><div class="preloader-spin"></div></div>
        <div class="gem-featured-posts-slider <?php echo $slider_classes ?>"
    ...
    <?php else: ?>
        <div class="gem-featured-posts-slider-empty">
            <p><?php echo __('No featured posts to display are selected.', 'thegem'); ?></p>
        </div>
    <?php endif; ?>
