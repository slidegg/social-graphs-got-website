...
function thegem_elements_scripts() {
	...
	wp_register_style('thegem-portfolio-products', get_template_directory_uri() . '/css/thegem-portfolio-products.css');
	wp_register_style('thegem-news-grid', get_template_directory_uri() . '/css/news-grid.css');
	wp_register_style('thegem-news-grid-hovers', get_template_directory_uri() . '/css/news-grid-hovers.css');

	wp_register_style('thegem-news-grid-version-new-hovers-default', get_template_directory_uri() . '/css/thegem-news-grid-version-new/default.css');
	wp_register_style('thegem-news-grid-version-new-hovers-zooming-blur', get_template_directory_uri() . '/css/thegem-news-grid-version-new/zooming-blur.css');
	wp_register_style('thegem-news-grid-version-new-hovers-horizontal-sliding', get_template_directory_uri() . '/css/thegem-news-grid-version-new/horizontal-sliding.css');
	wp_register_style('thegem-news-grid-version-new-hovers-vertical-sliding', get_template_directory_uri() . '/css/thegem-news-grid-version-new/vertical-sliding.css');
	wp_register_style('thegem-news-grid-version-new-hovers-gradient', get_template_directory_uri() . '/css/thegem-news-grid-version-new/gradient.css');
	wp_register_style('thegem-news-grid-version-new-hovers-circular', get_template_directory_uri() . '/css/thegem-news-grid-version-new/circular.css');

	wp_register_style('thegem-news-grid-version-default-hovers-default', get_template_directory_uri() . '/css/thegem-news-grid-version-default/default.css');
	wp_register_style('thegem-news-grid-version-default-hovers-zooming-blur', get_template_directory_uri() . '/css/thegem-news-grid-version-default/zooming-blur.css');
	wp_register_style('thegem-news-grid-version-default-hovers-horizontal-sliding', get_template_directory_uri() . '/css/thegem-news-grid-version-default/horizontal-sliding.css');
	wp_register_style('thegem-news-grid-version-default-hovers-vertical-sliding', get_template_directory_uri() . '/css/thegem-news-grid-version-default/vertical-sliding.css');
	wp_register_style('thegem-news-grid-version-default-hovers-gradient', get_template_directory_uri() . '/css/thegem-news-grid-version-default/gradient.css');
	wp_register_style('thegem-news-grid-version-default-hovers-circular', get_template_directory_uri() . '/css/thegem-news-grid-version-default/circular.css');

	wp_register_style('thegem-gallery', get_template_directory_uri() . '/css/gallery.css');
	wp_register_style('thegem-pricing-tables', get_template_directory_uri() . '/css/thegem-pricing-tables.css');
	wp_register_style('thegem-testimonials', get_template_directory_uri() . '/css/thegem-testimonials.css');
    wp_register_style('thegem-featured-posts-slider', get_template_directory_uri() . '/css/thegem-featured-posts-slider.css');
	...
	wp_register_script('thegem-widgets', get_template_directory_uri() . '/js/widgets.js', array('jquery', 'jquery-carouFredSel'), false, true);
	...
	wp_register_script('thegem-portfolio', get_template_directory_uri() . '/js/portfolio.js', array('jquery', 'thegem-scroll-monitor'), '', true);
	wp_register_script('thegem-juraSlider', get_template_directory_uri() . '/js/jquery.juraSlider.js', array('jquery', 'thegem-portfolio'), '', true);
	wp_register_script('thegem-countdown', get_template_directory_uri() . '/js/thegem-countdown.js', array( 'jquery', 'raphael', 'odometr' ), '', true );
	...
	wp_register_script('thegem-team-hover', get_template_directory_uri() . '/js/thegem-team-hover.js', array('jquery'), '', true);
	wp_register_script('thegem-counters-effects', get_template_directory_uri() . '/js/counters-effects.js', array('jquery'), false, true);
	wp_register_script('thegem-counter', get_template_directory_uri() . '/js/thegem-counters.js', array( 'odometr', 'thegem-counters-effects', 'jquery' ), '', true );
    wp_register_script('thegem-featured-posts-slider', get_template_directory_uri() . '/js/thegem-featured-posts-slider.js', array('jquery','jquery-carouFredSel'), '', true);
}
